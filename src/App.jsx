...
const onScroll = () => {
  ...
  // const imageWidth = (1600/ScrollPercent)*2
...
window.addEventListener("scroll", onScroll); 
  return (
    <div>
    <ScrollContainer>
      <ScrollPage page={0} speed={0.1}>
        <Animator  animation={batch(Sticky(50,-50), MoveOut(0, 1100))}>
        <img src="./Images/topdesign1.png" 
        style={{transform: `scale(0.${topimageWidth})`}}
        
        className={`transition-all duration-[200ms] ease-linear`} alt="" width={250}/>

        </Animator>
      </ScrollPage>
        <ScrollPage page={1}>
        <Animator  animation={batch(Sticky(70,70), MoveIn(2000, 0), MoveOut(0,-1000),Fade())}>
        <p className={`text-3xl text-[#2a60a5] font-bold transition-all duration-[2500ms]`}>A PURIFED ECOSYSTEM FOR WEB3</p>
        </Animator>
        <Animator  animation={batch(Sticky(50,80), MoveOut(0, -1000))}>
        <img src="./Images/1stbottom.png" className="" alt="" width={300} height={300}/>
        </Animator>

</ScrollPage>
      <ScrollPage page={2}>
      <Animator  animation={batch(Sticky(50,30), FadeIn(), MoveIn(10, 600), MoveOut(0,230))}>
      <img src="./Images/2ndpgdesign.png" 
      style={{transform: `scale(0.${secondimageWidth})`}}
      className={`transition-all duration-[500ms] ease-in`} alt="" width={250}/>
      </Animator>
</ScrollPage>
<ScrollPage page={3}>
<Animator  animation={batch(Sticky(30,70), MoveIn(-1000, 0), MoveOut(0,-1000),Fade())}>
        <p className={`text-3xl text-[#2a60a5] font-bold transition-all duration-[2500ms] ease-in`}>THAT FILTERS CONTENT</p>
        </Animator>
        <Animator  animation={batch(Sticky(50,85),MoveOut(0, -1000), FadeIn())}>
        <img src="./Images/2ndpgbase.png" className="" alt="" width={300} height={300}/>
        </Animator>
</ScrollPage>
<ScrollPage page={4}>
      <Animator  animation={batch(Sticky(50,40), FadeIn(),MoveIn(10, 500),MoveOut(0,200))}>
      <div>
...
<ScrollPage page={5}>
        <Animator  animation={batch(Sticky(50,90),MoveOut(0, -600), FadeIn())}>
...
<ScrollPage page={7}>
        ...
        <img src="./Images/bottomtop.png" className="transition-all   ease-in" alt="" width={400}/>
        </Animator>
        <Animator  animation={batch(Sticky(50,25), FadeIn())}>
          <div className="w-full flex flex-col gap-4">
          <div className="flex justify-center items-center gap-4">
            <div>
          <img src="./Images/bottomdesign1.png" className="transition-all   ease-in" alt="" width={120}/>
          </div>
          <div>
          <img src="./Images/bottomdesign3.png" className="transition-all   ease-in" alt="" width={120}/>
          </div>
          <div>
          <img src="./Images/bottomdesign2.png" className="transition-all   ease-in" alt="" width={120}/>
          </div>
        ...
        <img src="./Images/bottombase.png" className="w-[100vw] fixed bottom-0" alt=""/>
        </Animator>
</ScrollPage>
</ScrollContainer>
</div>
